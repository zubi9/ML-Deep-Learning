    ...
    function t(t, s) {
      ...
      for (var f = 0; f < this.els.length; f++) {
        ...
        this.props.applyStyle(
          { styles: ((u = {}), (u[a] = c), (u.position = p), u), classes: {} },
          h
        ),
          this.manageState(h),
    ...
    return (
      ...
      (s.manageState = function (r) {
        var c = this,
          ...
          S = a && C <= e && ("sticky" === t || "stuck" === t),
          w = n <= C && "sticky" === t;
        e < C && C < n && ("default" === t || "stuck" === t)
          ? (p.state = "sticky")
          : S
          ? (p.state = "default")
          : w && (p.state = "stuck");
            ...
            v(function () {
              var t,
                ...
                a = {
                  sticky: {
                    styles:
                      ((t = { position: u, top: "", bottom: "" }),
                      (t[g] = f.stickyBitStickyOffset + "px"),
                      t),
                    classes: ((s = {}), (s[y] = !0), s),
                  },
      ...
      (s.applyStyle = function (t, s) {
        ...
        if (
          ((o.className = c.join(" ")),
          e.position && (l.position = e.position),
          !r)
        )
          for (var u in e) l[u] = e[u];
      }),
      (s.update = function (e) {
        var i = this;
        return (
        ...
        this.applyStyle(
          {
            ...
            classes:
              ((e = {}), (e[n.stickyClass] = ""), (e[n.stuckClass] = ""), e),
          },
          t
        ),
